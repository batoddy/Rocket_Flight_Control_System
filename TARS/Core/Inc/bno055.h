...
/** Sensorun modlarini konfigure etmek icin datasheet'de
 * configuration tablolari var burda istenilen modun degeri sirasi ve config registeri alinir.
 * Sonra registera degerin sirasini yazma islemi yapilir
 * Mesala accel icin Bandwith configurasyonunda 250Hz besinci sirada ve registeri
 * ACC_CONFIG configdir. Datasheete uygun sekilde bu modun binary degeri registera yazilir.
 *
**/

// Accelometer Config pg27
enum AccelScale {  // ACC Range
    AFS_2G = 0,
    AFS_4G,
    AFS_8G,
    AFS_16G
};
enum AccelBandwidth { // ACC Bandwidth
    ABW_7_81Hz = 0,
    ABW_15_63Hz,
    ABW_31_25Hz,
    ABW_62_5Hz,
...
enum AccelPwrMode { // ACC Pwr Mode
    NormalA = 0,
    SuspendA,
    LowPower1A,
    StandbyA,
...
enum GyroBandwith { // gyro bandwidth
    GBW_523Hz = 0,
    GBW_230Hz,
    GBW_116Hz,
    GBW_47Hz,
...
// pg29
enum MagnnetometerOutputRate {         // magnetometer output data rate
    MODR_2Hz = 0,
    MODR_6Hz,
    MODR_8Hz,
    MODR_10Hz,
...
enum MagnetometerOperMode { // MAG Op Mode
    LowPower = 0,
    Regular,
    EnhancedRegular,
    HighAccuracy
...
enum MagnetometerPowerMode { // MAG power mode
    Normal = 0,
    Sleep,
    Suspend,
    ForceMode
